...
//! named. What a path under a mount may reach is [`local`]'s.
...
mod tests {
    ...
    /// the first of them.
    pub(super) fn with_paths(paths: &[&Path], follow_symlinks: bool) -> AccessPolicy {
    ...
    pub(super) fn temp_dir() -> (TempDir, PathBuf) {
