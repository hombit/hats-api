...
pub use options::{
    Authorities, AzureOptions, GcsOptions, HEADERS, Headers, HfOptions, HttpOptions, S3Options,
    StorageOptions, WebdavOptions, WebdavTransport, option_names, option_schemes,
};
pub use store::{
